...
const TaskDetails = () => {
  ...
  return (
    <div className="w-full flex-col gap-3 mb-4 overflow-y-hidden">
          ...
          <>
            <div className="w-full flex flex-col md:flex-row gap-5 2xl:gap-8 bg-white shadow-md p-8 overflow-y-auto">
                      ...
                      <div key={index}
                        ...
                        <div className="space-y-1">
                          <div className="flex gap-2 items-center">
                            ...
                            <span className="px-2 py-0.5 text-center text-sm rounded-full bg-violet-100 text-violet-700 font-semibold">{el?.tag}
                            </span>
                          </div>
              ...
              <div className="w-full md:w-1/2 space-y-8">
                ...
                <p className="text-gray-900 text-lg">{task?.description}</p>
