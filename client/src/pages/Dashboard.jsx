...
const TaskTable = ({ tasks, fullWidth }) => {
    const ICONS = {
    ...
    return (
        <>
            <div className={clsx("bg-white px-2 md:px-4 pt-4 pb-4 shadow-md rounded", { "w-full": fullWidth, "md:w-2/3": !fullWidth })}>
    ...
    return (
        <div className="h-full py-4">
            ...
            <div className="w-full bg-white my-16 p-4 rounded shadow-sm">
                <h4 className="text-xl text-gray-600 font-semibold " >Chart By Priority
                </h4>
            ...
            <div className="w-full flex flex-col md:flex-row gap-4 2xl:gap-10 py-8">
                ...
                <TaskTable tasks={data?.last10Task} fullWidth={!isAdmin} />

                {/* right */}
                {/* <UserTable users={data?.users} /> */}
                {isAdmin && <UserTable users={data?.users} />}
